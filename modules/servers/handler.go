...
import (
	_usersHttp "fiber-postgres-api/modules/users/controllers"
	_usersRepository "fiber-postgres-api/modules/users/repositories"
	_usersUsecase "fiber-postgres-api/modules/users/usecases"
